...
set @query = 'SELECT ROW_NUMBER() Over (Order by FullName) AS SN, STDID, StudentNo, FullName, ' + @cols2 + ' INTO ACDBroadsheet from (select STDID, StudentNo, FullName, Subject, TotalMark
